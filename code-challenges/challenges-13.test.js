...
Write a function named longestString that takes in an array of strings
 ...
 2. get the index of longest character in string .
 3. get the character the index.
 4. send it back.
------------------------------------------------------------------------------------------------ */
...
const firstLetters = (arr) => {
  // Solution code here...
  let arrayOfLetters = arr.map(item => {
...
const onlyOddChars = (str) => {
  // Solution code here...
  let returnStr = str.split('').filter((char, idx) => {
    return idx % 2 === 1;
  })
...
Write a function named allHappy that takes in an array of strings and 
returns a Boolean indicating whether all those strings contain ":)".
------------------------------------------------------------------------------------------------ */
