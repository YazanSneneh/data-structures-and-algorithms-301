...
const replaceZeros = (string) => {
  ...
  let returnString = '';
  const regex = /0/g
  returnString = string.replace(regex, 'zero')
  return returnString;
}
...
const addOne = (arr) => {
  // Solution code here...
  let returnArray = arr.map(number => {
    return number + 1;
  })
  return returnArray;
}
...
const addQuestion = (arr) => {
  // Solution code here...
  let returnArray = arr.map(string => {
    return string + '?'
  })
  return returnArray;
}
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    raisedToPower.push(Math.pow(2, arr[i]))
  }
...
that produces the same output as your forLoopTwoToThe function from challenge 1, 
...
const forEachTwoToThe = (arr) => {
  ...
  let returnArray = []
  arr.forEach(number => {
    returnArray.push(Math.pow(2, number))
  })
  return returnArray;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let raisedToPower = arr.map(number => {
